	...
	//업로드 폴더까지의 경로 얻어오기
	   ...
	   public boolean simpleMailSender(Map<String, Object> map) throws EmailException {
		   String emailAddr = ""; //보내는 사람
			...
			String name = "하딘이"; //보내는 사람 이름
			String hostname = "smtp.office365.com"; //smtp 주소
			int port = 587; //포트가 뭔지 모르면 검색해야 합니다.
			...
			mail.setAuthentication(emailAddr, passwd); //고정 인증부분
